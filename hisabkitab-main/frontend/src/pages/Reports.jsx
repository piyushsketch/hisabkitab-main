...
const Reports = () => {
    ...
    const handleExportExcel = async () => {
        ...
        worksheet.columns = [
            ...
            { header: 'Udhar Given', key: 'credit', width: 20 },
            { header: 'Payment Received', key: 'debit', width: 20 },
            { header: 'Cash Sale', key: 'nagad', width: 20 }
        ];
        ...
        // Add borders and center alignment to data
        worksheet.eachRow((row, rowNumber) => {
            // Skip header row for general data styling if we want distinct styles, 
            // but here we just apply borders to everything.
            if (rowNumber > 1) {
                row.eachCell((cell) => {
                    cell.border = {
                        top: { style: 'thin' },
                    ...
                    // optional: align numbers to right, text to left? 
                    // For now, let's keep it simple or default.
                });
            }
        });
